					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="panel panel-primary">
								...
								<div class="panel-footer">
									<h4 style="font-size:15px;font-weight:700;"><a href='index.php?page=barang'>Tabel
											Barang <i class='fa fa-angle-double-right'></i></a></h4>
								</div>
							</div>
							<!--/grey-panel -->
						</div><!-- /col-md-3-->
						...
						<div class="col-md-3">
							<div class="panel panel-danger">
								...
								<div class="panel-footer">
									<h4 style="font-size:15px;font-weight:700;"><a href='index.php?page=kategori'>Tabel
											Kategori <i class='fa fa-angle-double-right'></i></a></h4>
								</div>
							</div>
							<!--/grey-panel -->
						</div><!-- /col-md-3-->
